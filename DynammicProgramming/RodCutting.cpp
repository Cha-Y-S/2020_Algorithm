...
int rodCutting(int n, int value[])
{
    ...
    // we will calculate the maximum attainable value of
    // rod in a bottom up fashion by first calculating for smaller
    // value of n and then using these values to calculate higher values of n
